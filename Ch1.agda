...
deMorgan1 (notA , notB) (inl a) = notA a -- contradiction!
...
recNiter= {C} {c0} {cs} n = cs= n'= -- or, as spelled out below
  ...
  where
    ...
    -- the first (counter) projection of the iter version of recN is indeed n
    ...
    fstIter'= = indN idp inductiveCase where
      ...
      inductiveCase m p = suc= p -- or, as spelled out below
        ...
        -- -- fst (suc (fst (iter (0 , c0) cs' m)) , _) =⟨ idp ⟩ -- type data here, so keep commented out
